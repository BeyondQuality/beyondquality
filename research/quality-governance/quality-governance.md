...
- The channels and measures of the value model belong to the economics research's value chapter (to be linked when it lands); this section states the ordering and the two halves.
...
- Once the value chapter exists, the framework also implements value generation for quality.
...
This section carries the research's own claim, beyond what the two linked researches state separately.

- AI-accelerated development does not merely add rows to the risk register. It erodes the organization's capacity to run the register at all: risk identification needs intent, evidence evaluation needs comprehension, and agent-mediated construction depletes both unless countermeasures are taken.
...
- Knowledge that used to be a free byproduct of humans doing the work becomes a priced input. Someone has to decide to pay for it (human-authored anchors, collaborative construction, oversight skills), and that decision is a governance act: policy, delegation limits, and the human-oversight conditions of 38507 6.2 (understanding, authority, the ability to intervene).
...
This section is the practice layer; its meat comes after the structure review.
...
1. This hub.
2. [Economics of Testing](../testing_economics/testing_economics.md): the risk-governance and oversight machinery. Its AI-era addendum and value chapter are planned.
